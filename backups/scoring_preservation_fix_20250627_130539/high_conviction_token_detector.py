    ...
    def _capture_api_usage_stats(self):
        ...
        try:
            ...
            if hasattr(self, 'birdeye_api') and self.birdeye_api:
                ...
                self.logger.debug(f"🔍 Captured Birdeye stats: {birdeye_stats}")
            ...
            if hasattr(self, 'cross_platform_analyzer'):
                ...
                self.logger.debug(f"🔍 Captured cross-platform stats: {cross_platform_stats}")
                ...
                # Capture emerging token discovery stats (Jupiter/Meteora)
