...
class TelegramAlerter:
    ...
    def send_gem_alert(self, metrics: MinimalTokenMetrics, score: float, score_breakdown: Optional[dict] = None, enhanced_data: Optional[dict] = None, pair_address: Optional[str] = None, scan_id: Optional[str] = None):
        ...
        try:
            ...
            # 🔢 SCORING BREAKDOWN - Detailed scoring analysis
            scoring_breakdown = self._build_scoring_breakdown_section(enhanced_data)
            if scoring_breakdown:
                sections.append(scoring_breakdown)
    ...
    def _build_scoring_breakdown_section(self, enhanced_data: Optional[dict]) -> str:
        """Build detailed scoring breakdown section"""
